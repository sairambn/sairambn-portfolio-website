  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className="shrink-0 text-[15px] text-muted-foreground transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-primary"
          aria-hidden="true"
        >
          ↗
        </span>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-2">
        ...
        {project.live && (
          <span className="ml-auto rounded-full border border-primary/25 bg-primary/10 px-2.5 py-1 font-mono text-[11px] text-primary">
            Live
          </span>
        )}
      </div>
